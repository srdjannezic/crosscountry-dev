...
use Cc\Authors\Models\AuthorsModel as Author;
...
class Posts extends ComponentAbstract
{
    ...
    protected function prepareVars()
    {
        ...
        $this->page['author'] = $this->property('authorFilter');
    }
    ...
    protected function listPosts()
    {
        ...
        $author_slug = $this->property('authorFilter');
        if($author_slug){
        $author_id = Author::where('slug',$author_slug)->first()->id;
        }
        else{
            $author_id = null;
        }
